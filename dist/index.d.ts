...
declare const Backdrop: ({ sekai, themeMode, open, children, containerComponent, centered, blur, ...rest }: BackdropProps) => React__default.ReactPortal | null;
...
declare const PrskTips: ({ sekai, themeMode, open, tipsText, containerComponent, withOverlay, ...rest }: PrskTipsProps) => React__default.ReactPortal | null;
...
declare const IntoTheSekai: ({ execEvent, execEventDelay, clickThrough, containerComponent, ...rest }: IntoTheSekaiProps) => React__default.ReactPortal | null;
...
declare const Slider: ({ id, className, style, sekai, themeMode, value, defaultValue, min, max, step, onChange, disabled, orientation, showValue, }: SliderProps) => React__default.JSX.Element;
