...
var getTrackColor = function getTrackColor(sekaiColor, isLight) {
  return converter.convertHexToRgba(sekaiColor, isLight ? 0.2 : 0.3);
};
var getSliderClassName = function getSliderClassName(modeTheme, isVertical, disabled, className) {
  return clsx(Slider_module['sekai-slider'], Slider_module["sekai-slider--".concat(modeTheme)], isVertical && Slider_module['sekai-slider--vertical'], disabled && Slider_module['sekai-slider--disabled'], className);
};
var renderValueTooltip = function renderValueTooltip(showValue, currentValue) {
  if (!showValue) return null;
  return /*#__PURE__*/React.createElement("div", {
    className: Slider_module['sekai-slider-value'],
    "aria-hidden": "true"
  }, currentValue);
};
var Slider = function Slider(_ref) {
  ...
  var _useState = React.useState(getInitialValue(value, defaultValue)),
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: Slider_module['sekai-slider-track']
  }, /*#__PURE__*/React.createElement("div", {
    className: Slider_module['sekai-slider-fill']
    ...
    className: Slider_module["sekai-slider-input--".concat(modeTheme)]
  })));
};
