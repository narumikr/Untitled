...
var renderLabel = function renderLabel(labelText, shouldRender) {
  ...
  return /*#__PURE__*/React.createElement("span", {
    className: ToggleButton_module['sekai-toggle-label'],
...
var ToggleButton = function ToggleButton(_ref) {
  ...
  var sekaiColorBg = converter.convertHexToRgba(sekaiColor, 0.12);
  var optionStyle = {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, rest, {
    ...
    className: clsx(ToggleButton_module['sekai-toggle-button'], ToggleButton_module["sekai-toggle-button--".concat(modeTheme)], direction === 'vertical' && ToggleButton_module['sekai-toggle-button--vertical'], rest.className),
    style: _objectSpread(_objectSpread({}, optionStyle), rest.style)
  }), renderLabel(labelText, isLabelBefore), /*#__PURE__*/React.createElement("span", {
    className: clsx(ToggleButton_module['sekai-toggle-track'], checked && ToggleButton_module['sekai-toggle-track--on'])
  }, /*#__PURE__*/React.createElement("span", {
    className: clsx(ToggleButton_module['sekai-toggle-thumb'], checked && ToggleButton_module['sekai-toggle-thumb--on'])
