...
var Tab = function Tab(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    role: "tablist",
    className: clsx(Tab_module['sekai-tab'], Tab_module["sekai-tab--".concat(variant)], Tab_module["sekai-tab--".concat(modeTheme)], rest.className),
...
var TabItemButton = function TabItemButton(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    onKeyDown: onKeyDown,
    onClick: onClick,
    className: clsx(Tab_module['sekai-tab-item'], Tab_module["sekai-tab-item--".concat(variant)], Tab_module["sekai-tab-item--".concat(modeTheme)], selected && Tab_module['sekai-tab-item--selected'])
