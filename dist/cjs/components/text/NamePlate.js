...
var _excluded = ["sekai", "themeMode", "text", "colorLength"];
...
var NamePlate = function NamePlate(_ref) {
  var sekai = _ref.sekai,
    ...
    text = _ref.text,
    _ref$colorLength = _ref.colorLength,
    colorLength = _ref$colorLength === void 0 ? 1 : _ref$colorLength,
  ...
  var colorText = text.slice(0, colorLength);
  var normalText = text.slice(colorLength);
