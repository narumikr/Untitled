...
var TextLink_module = require('./TextLink.module.scss.js');
...
var TextLink = function TextLink(_ref) {
  ...
  var sekaiColorHover = converter.convertHexToRgba(sekaiColor, isLight ? 0.2 : 0.6);
  var optionStyle = {
  ...
  return /*#__PURE__*/React.createElement("a", _extends({}, rest, {
    ref: rest.ref,
    className: clsx(TextLink_module["sekai-text-link-".concat(modeTheme)], disabled && TextLink_module['sekai-disabled'], rest.className),
