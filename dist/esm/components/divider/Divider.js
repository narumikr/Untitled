...
var Divider = function Divider(_ref) {
  ...
  var gradientColor = pairSekaiColor ? colorsSekai[pairSekaiColor] : 'transparent';
  var shadowStyle = Boolean(shadow) ? styles["sekai-divider-shadow-".concat(modeTheme)] : '';
  var optionStyle = {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rest, {
    className: clsx(styles["sekai-divider-".concat(variant)], rest.className),
    style: _objectSpread(_objectSpread({}, optionStyle), rest.style)
  }), children ? /*#__PURE__*/React.createElement("div", {
    role: "separator",
    "aria-orientation": "horizontal",
    className: clsx(styles["sekai-divider-with-item-".concat(textAlign)], shadowStyle)
